import type { LineChannelData, QingClawsPluginApi, ReplyPayload } from "openclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: QingClawsPluginApi): void {
  api.registerCommand({
    name: "card",
