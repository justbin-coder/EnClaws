...
This is the official Lark/Feishu plugin for QingClaws, developed and maintained by the Lark/Feishu Open Platform team. It seamlessly connects your QingClaws Agent to your Lark/Feishu workspace, enabling it to directly read from and write to messages, docs, bases, calendars, tasks, and more.

## Features

This plugin provides comprehensive Lark/Feishu integration for QingClaws, including:
...
This plugin integrates with QingClaws AI automation capabilities and carries inherent risks such as model hallucinations, unpredictable execution, and prompt injection. After you authorize Lark/Feishu permissions, QingClaws will act under your user identity within the authorized scope, which may lead to high-risk consequences such as leakage of sensitive data or unauthorized operations. Please use with caution.
...
We recommend using the Lark/Feishu bot connected to QingClaws as a private conversational assistant. Do not add it to group chats or allow other users to interact with it, to avoid abuse of permissions or data leakage.
...
- [Feishu Privacy Policy](https://www.feishu.cn/en/privacy?from=qingclaws_plugin_readme)
- [Feishu User Terms of Service](https://www.feishu.cn/en/terms?from=qingclaws_plugin_readme)
...
- **QingClaws**: QingClaws is installed and works properly. For details, visit the [QingClaws official website](https://qingclaws.ai).

> **Note**: QingClaws version must be **2026.2.26** or higher. Check with `qingclaws -v`. If below this version, you may encounter issues. Upgrade with:
> ```bash
...
[How to Use the Official Lark/Feishu Plugin for QingClaws](https://bytedance.larkoffice.com/docx/MFK7dDFLFoVlOGxWCv5cTXKmnMh)

## Contributing

Community contributions are welcome! If you find a bug or have feature suggestions, please submit an [Issue](https://github.com/larksuite/qingclaws-larksuite/issues) or a [Pull Request](https://github.com/larksuite/qingclaws-larksuite/pulls).
