...
Nostr DM channel plugin for QingClaws using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to QingClaws. It enables your bot to:
...
# Configure qingclaws to use local relay
