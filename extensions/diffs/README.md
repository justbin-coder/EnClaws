...
Read-only diff viewer plugin for **QingClaws** agents.
...
Set plugin-wide defaults in `~/.qingclaws/qingclaws.json`:
...
Before:
QingClaws supports plugins.

After:
QingClaws supports plugins and hosted diff views.
```
