    ...
    channel: {
      ...
      routing: {
        ...
        buildAgentMainSessionKey:
          vi.fn() as unknown as PluginRuntime["channel"]["routing"]["buildAgentMainSessionKey"],
      },
      pairing: {
        buildPairingReply:
      ...
      session: {
        ...
        resolveTenantSessionStorePath:
          vi.fn() as unknown as PluginRuntime["channel"]["session"]["resolveTenantSessionStorePath"],
        ensureTenantSessionDirs:
          vi.fn() as unknown as PluginRuntime["channel"]["session"]["ensureTenantSessionDirs"],
