---
summary: "Synology Chat webhook setup and QingClaws config"
read_when:
  - Setting up Synology Chat with QingClaws
...
```bash
qingclaws plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your QingClaws gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in QingClaws.
...
- Pairing approvals work with:
  - `qingclaws pairing list synology-chat`
  - `qingclaws pairing approve synology-chat <CODE>`
...
```bash
qingclaws message send --channel synology-chat --target 123456 --text "Hello from QingClaws"
qingclaws message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
