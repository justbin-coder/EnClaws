...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure QingClaws HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `qingclaws pairing approve slack <code>`.
...
QingClaws supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, QingClaws falls back to normal delivery for remaining payloads.
