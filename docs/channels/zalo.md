...
- Install via CLI: `qingclaws plugins install @qingclaws/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `qingclaws plugins install ./extensions/zalo`
   - From npm (if published): `qingclaws plugins install @qingclaws/zalo`
...
- Approve via:
  - `qingclaws pairing list zalo`
  - `qingclaws pairing approve zalo <CODE>`
...
- Example: `qingclaws message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `qingclaws channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `qingclaws logs --follow`
