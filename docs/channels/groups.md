...
QingClaws treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

QingClaws “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, QingClaws can see that group and respond there.
...
Translation: allowlisted senders can trigger QingClaws by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@qingclaws", "qingclaws", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
