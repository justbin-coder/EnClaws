...
read_when:
  - You want QingClaws to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables QingClaws to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`qingclaws onboard`) and `qingclaws channels add` list optional channel plugins.
...
```bash
qingclaws plugins install @qingclaws/nostr
```

Use a local checkout (dev workflows):

```bash
qingclaws plugins install --link <path-to-qingclaws>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "qingclaws",
        "displayName": "QingClaws",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "qingclaws@example.com",
        "lud16": "qingclaws@example.com"
      }
    }
  }
}
