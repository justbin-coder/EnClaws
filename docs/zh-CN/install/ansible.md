...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 QingClaws 安装
title: Ansible
x-i18n:
...
>
> qingclaws-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 或直接运行（然后手动执行 /tmp/qingclaws-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 QingClaws

Ansible 安装程序设置 QingClaws 为手动更新。标准更新流程参见[更新](/install/updating)。
