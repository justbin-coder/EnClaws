...
本指南总结了在 QingClaws 中开发 Pi 集成的合理工作流程。
...
状态存储在 QingClaws 状态目录下。默认为 `~/.qingclaws`。如果设置了 `QINGCLAWS_STATE_DIR`，则使用该目录。
...
- https://docs.qingclaws.ai/testing
- https://docs.qingclaws.ai/start/getting-started
