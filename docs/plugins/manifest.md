...
read_when:
  - You are building a QingClaws plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (qingclaws.plugin.json)

Every plugin **must** ship a `qingclaws.plugin.json` file in the **plugin root**.
QingClaws uses this manifest to validate configuration **without executing plugin
