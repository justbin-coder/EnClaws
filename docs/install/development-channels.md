...
QingClaws ships three update channels:
...
When you **explicitly** switch channels with `--channel`, QingClaws also aligns
the install method:
...
When you switch channels with `qingclaws update`, QingClaws also syncs plugin sources:
