...
qingclaws system heartbeat last
qingclaws logs --follow
qingclaws config get agents.defaults.heartbeat
qingclaws channels status --probe
```
...
```bash
qingclaws config get agents.defaults.heartbeat.activeHours
qingclaws config get agents.defaults.heartbeat.activeHours.timezone
qingclaws config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
qingclaws cron list
qingclaws logs --follow
```
