---
summary: "Frequently asked questions about QingClaws setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up QingClaws?](#whats-the-recommended-way-to-install-and-set-up-qingclaws)
  ...
  - [I can't access docs.qingclaws.ai (SSL error). What now?](#i-cant-access-docsqingclawsai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or qingclaws not recognized](#windows-install-says-git-not-found-or-qingclaws-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install QingClaws on Linux?](#how-do-i-install-qingclaws-on-linux)
  - [How do I install QingClaws on a VPS?](#how-do-i-install-qingclaws-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask QingClaws to update itself?](#can-i-ask-qingclaws-to-update-itself)
  ...
  - [If I buy a Mac mini to run QingClaws, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-qingclaws-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different QingClaws instances?](#can-multiple-people-use-one-whatsapp-number-with-different-qingclaws-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run QingClaws on a dedicated machine?](#how-important-is-it-to-run-qingclaws-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run QingClaws in a VM and what are the requirements](#can-i-run-qingclaws-in-a-vm-and-what-are-the-requirements)
- [What is QingClaws?](#what-is-qingclaws)
  - [What is QingClaws, in one paragraph?](#what-is-qingclaws-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for QingClaws](#what-are-the-top-five-everyday-use-cases-for-qingclaws)
  - [Can QingClaws help with lead gen outreach ads and blogs for a SaaS](#can-qingclaws-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can QingClaws run tasks on a schedule or continuously in the background?](#can-qingclaws-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with QingClaws saved locally?](#is-all-data-used-with-qingclaws-saved-locally)
  - [Where does QingClaws store its data?](#where-does-qingclaws-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall QingClaws?](#how-do-i-completely-uninstall-qingclaws)
...
- [Config basics](#config-basics)
  ...
  - [Can the QingClaws browser run headless?](#can-the-qingclaws-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two QingClaws instances talk to each other (local + VPS)?](#can-two-qingclaws-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does QingClaws load environment variables?](#how-does-qingclaws-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of QingClaws instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-qingclaws-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset QingClaws but keep it installed?](#how-do-i-completely-reset-qingclaws-but-keep-it-installed)
  ...
  - [Why doesn't QingClaws reply in a group?](#why-doesnt-qingclaws-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do QingClaws, Flawd, and Krill use for models?](#what-do-qingclaws-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `qingclaws gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-qingclaws-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `qingclaws gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-qingclaws-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run QingClaws in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-qingclaws-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart QingClaws?](#i-closed-my-terminal-on-windows-how-do-i-restart-qingclaws)
  ...
  - [ELI5: `qingclaws gateway restart` vs `qingclaws gateway`](#eli5-qingclaws-gateway-restart-vs-qingclaws-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose QingClaws to inbound DMs?](#is-it-safe-to-expose-qingclaws-to-inbound-dms)
...
7. **Gateway snapshot**
   ...
   qingclaws health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://qingclaws.ai/install.sh | bash -s -- --install-method git
```

This installs QingClaws **from a git checkout**, so the agent can read the code + docs and
...
```bash
qingclaws status
qingclaws models status
qingclaws doctor
```

What they do:

- `qingclaws status`: quick snapshot of gateway/agent health + basic config.
- `qingclaws models status`: checks provider auth + model availability.
- `qingclaws doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `qingclaws status --all`, `qingclaws logs --follow`,
`qingclaws gateway status`, `qingclaws health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up QingClaws

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://qingclaws.ai/install.sh | bash
qingclaws onboard --install-daemon
```
...
If you don't have a global install yet, run it via `pnpm qingclaws onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `QINGCLAWS_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `qingclaws config get gateway.auth.token` (or generate one: `qingclaws doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `qingclaws gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `qingclaws gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install QingClaws on the new machine.
2. Copy `$QINGCLAWS_STATE_DIR` (default: `~/.qingclaws`) from the old machine.
3. Copy your workspace (default: `~/.qingclaws/workspace`).
4. Run `qingclaws doctor` and restart the Gateway service.
...
under `~/.qingclaws/` (for example `~/.qingclaws/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-qingclaws-store-its-data),
...
### I can't access docs.qingclaws.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.qingclaws.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.qingclaws.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsqingclawsai-shows-an-ssl-error-comcastxfinity).
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://qingclaws.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://qingclaws.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://qingclaws.ai/install.ps1](https://qingclaws.ai/install.ps1)
...
```bash
curl -fsSL https://qingclaws.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://qingclaws.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://qingclaws.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://qingclaws.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or qingclaws not recognized
...
**2) qingclaws is not recognized after install**
...
### How do I install QingClaws on Linux
...
### How do I install QingClaws on a VPS
...
### Can I ask QingClaws to update itself
...
```bash
qingclaws update
qingclaws update status
qingclaws update --channel stable|beta|dev
qingclaws update --tag <dist-tag|version>
qingclaws update --no-restart
```

If you must automate from an agent:

```bash
qingclaws update --yes --no-restart
qingclaws gateway restart
```
...
`qingclaws onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run QingClaws with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `qingclaws models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `qingclaws models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `qingclaws models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. QingClaws no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so QingClaws can keep replying while a provider is rate-limited.
...
QingClaws supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. QingClaws fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `qingclaws.json`.

Steps:

1. Enable the plugin: `qingclaws plugins enable google-gemini-cli-auth`
2. Login: `qingclaws models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. QingClaws needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. QingClaws runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run QingClaws can I connect it to my MacBook Pro
...
- Use `qingclaws nodes status` / `qingclaws nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but QingClaws authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `qingclaws logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different QingClaws instances
...
If you run QingClaws via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the QingClaws code install. Your state
(`~/.qingclaws`) and workspace (`~/.qingclaws/workspace`) stay untouched.
...
```bash
npm install -g qingclaws@latest
qingclaws doctor
qingclaws gateway restart
```
...
**QingClaws-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run QingClaws on a dedicated machine
...
QingClaws is lightweight. For a basic Gateway + one chat channel:
...
### Can I run QingClaws in a VM and what are the requirements
...
### What is QingClaws in one paragraph

QingClaws is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

QingClaws is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for QingClaws
...
### Can QingClaws help with lead gen outreach ads and blogs for a SaaS
...
QingClaws draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

QingClaws is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use QingClaws when you
...
Showcase: [https://qingclaws.ai/showcase](https://qingclaws.ai/showcase)
...
- Confirm cron is enabled (`cron.enabled`) and `QINGCLAWS_SKIP_CRON` is not set.
...
```bash
qingclaws cron run <jobId> --force
qingclaws cron runs --id <jobId> --limit 50
```
...
### Can QingClaws run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.qingclaws.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-qingclaws-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. QingClaws can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.qingclaws/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "qingclaws": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured QingClaws workspace); QingClaws treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.qingclaws/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
```bash
qingclaws browser extension install
qingclaws browser extension path
```
...
- Persist `/home/node` with `QINGCLAWS_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `QINGCLAWS_DOCKER_APT_PACKAGES`.
...
QingClaws memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

QingClaws also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, QingClaws auto-selects a provider when it
...
configured and present, QingClaws
prefers `local`.
...
### Is all data used with QingClaws saved locally

No - **QingClaws's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.qingclaws` + your workspace directory).
...
### Where does QingClaws store its data

Everything lives under `$QINGCLAWS_STATE_DIR` (default: `~/.qingclaws`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$QINGCLAWS_STATE_DIR/qingclaws.json`                             | Main config (JSON5)                                                |
| `$QINGCLAWS_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$QINGCLAWS_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$QINGCLAWS_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$QINGCLAWS_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$QINGCLAWS_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$QINGCLAWS_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$QINGCLAWS_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$QINGCLAWS_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.qingclaws/agent/*` (migrated by `qingclaws doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.qingclaws/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.qingclaws`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.qingclaws`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.qingclaws/skills`).

Default workspace is `~/.qingclaws/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.qingclaws/workspace" } },
}
```
...
Do **not** commit anything under `~/.qingclaws` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall QingClaws
...
`workspace` to the repo root. The QingClaws repo is just source code; keep the
...
If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.qingclaws/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `QINGCLAWS_GATEWAY_TOKEN`).
...
QingClaws enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `qingclaws doctor --generate-gateway-token`.
...
key. **Recommended:** run `qingclaws configure --section web` to store it in
...
- Daemons read env vars from `~/.qingclaws/.env` (or the service environment).
...
### Can the QingClaws browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   qingclaws nodes pending
   qingclaws nodes approve <requestId>
   ```
...
- Gateway is running: `qingclaws gateway status`
- Gateway health: `qingclaws status`
- Channel health: `qingclaws channels status`
...
### Can two QingClaws instances talk to each other local VPS
...
`qingclaws agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
qingclaws agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- If you have no backup, re-run `qingclaws doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `qingclaws config set` for small changes.
- Use `qingclaws configure` for interactive edits.
...
```bash
qingclaws gateway --tailscale serve
```
...
### How does QingClaws load environment variables

QingClaws reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.qingclaws/.env` (aka `$QINGCLAWS_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.qingclaws/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`QINGCLAWS_LOAD_SHELL_ENV=1`, `QINGCLAWS_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`qingclaws models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means QingClaws won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.qingclaws/.env`:
...
### Is there a way to make a team of QingClaws instances one CEO and many agents
...
### How do I completely reset QingClaws but keep it installed
...
```bash
qingclaws reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `QINGCLAWS_PROFILE`), reset each state dir (defaults are `~/.qingclaws-<profile>`).
- Dev reset: `qingclaws gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), QingClaws skips the heartbeat run to save API calls.
...
No. QingClaws runs on **your own account**, so if you're in the group, QingClaws can see it.
...
```bash
qingclaws directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't QingClaws reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.qingclaws/agents/<agentId>/sessions/`.
...
- Use `qingclaws doctor` to spot stray workspaces and profile mismatches.
...
QingClaws's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, QingClaws currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `qingclaws models set ...` (updates just model config)
- `qingclaws configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.openclaw/openclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `qingclaws doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do QingClaws, Flawd, and Krill use for models

- **QingClaws + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. QingClaws ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run `qingclaws agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so QingClaws can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.qingclaws/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.qingclaws/agent/*` (migrated by `qingclaws doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.qingclaws/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `qingclaws models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `qingclaws models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `qingclaws models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.qingclaws/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    qingclaws models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), QingClaws will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: QingClaws now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
QingClaws uses provider-prefixed IDs like:
...
QingClaws may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `qingclaws models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
qingclaws models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
qingclaws models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
qingclaws models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
qingclaws models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

QingClaws supports both:
...
```
--port > QINGCLAWS_GATEWAY_PORT > gateway.port > default 18789
```

### Why does qingclaws gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `qingclaws gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does qingclaws gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `QINGCLAWS_STATE_DIR` mismatch).

Fix:

```bash
qingclaws gateway install --force
```
...
QingClaws enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `qingclaws gateway --port <port>`.

### How do I run QingClaws in remote mode client connects to a Gateway elsewhere
...
- `qingclaws gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `qingclaws.control.settings.v1`.

Fix:

- Fastest: `qingclaws dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `qingclaws doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `QINGCLAWS_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `qingclaws status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `QINGCLAWS_CONFIG_PATH` (per-instance config)
- `QINGCLAWS_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `qingclaws --profile <name> …` per instance (auto-creates `~/.qingclaws-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `qingclaws --profile <name> gateway install`.

Profiles also suffix service names (`ai.qingclaws.<profile>`; legacy `com.qingclaws.*`, `qingclaws-gateway-<profile>.service`, `QingClaws Gateway (<profile>)`).
...
```
qingclaws tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$QINGCLAWS_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.qingclaws/logs/...`; profiles use `~/.qingclaws-<profile>/logs/...`)
- Linux: `journalctl --user -u qingclaws-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "QingClaws Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `qingclaws gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart QingClaws
...
1. Is the Gateway running? `qingclaws gateway status`
2. Is the Gateway healthy? `qingclaws status`
3. Does the UI have the right token? `qingclaws dashboard`
...
```bash
qingclaws channels status
qingclaws channels logs --channel telegram
```
...
### ELI5 qingclaws gateway restart vs qingclaws gateway

- `qingclaws gateway restart`: restarts the **background service** (launchd/systemd).
- `qingclaws gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `qingclaws gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [QingClaws assistant setup](/start/qingclaws) and [Agent send](/tools/agent-send).

CLI sending:

```bash
qingclaws message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose QingClaws to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `qingclaws pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `qingclaws pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `qingclaws doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. QingClaws only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
qingclaws pairing approve whatsapp <code>
```

List pending requests:

```bash
qingclaws pairing list whatsapp
```
...
QingClaws blocks **cross-provider** messaging by default. If a tool call is bound
