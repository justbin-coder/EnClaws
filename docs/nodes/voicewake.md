...
QingClaws treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.qingclaws/settings/voicewake.json`

Shape:

```json
{ "triggers": ["qingclaws", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
