...
You can point QingClaws at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or QingClaws
...
- [Anthropic provider](/providers/anthropic) - Native QingClaws integration with Claude setup-token or API keys
