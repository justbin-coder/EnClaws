---
summary: "Use Qianfan's unified API to access many models in QingClaws"
read_when:
...
3. QingClaws installed on your system
...
4. Copy the API key for use with QingClaws

## CLI setup

```bash
qingclaws onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [QingClaws Configuration](/gateway/configuration)
