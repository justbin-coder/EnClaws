---
summary: "Use NVIDIA's OpenAI-compatible API in QingClaws"
read_when:
  - You want to use NVIDIA models in QingClaws
...
qingclaws onboard --auth-choice skip
qingclaws models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
