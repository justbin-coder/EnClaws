---
summary: "Use Synthetic's Anthropic-compatible API in QingClaws"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. QingClaws registers it as the
...
Note: QingClaws's Anthropic client appends `/v1` to the base URL, so use
