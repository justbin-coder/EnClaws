---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with QingClaws"
read_when:
  - You want Xiaomi MiMo models in QingClaws
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). QingClaws uses
