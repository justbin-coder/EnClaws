---
summary: "Use Qwen OAuth (free tier) in QingClaws"
read_when:
  - You want to use Qwen with QingClaws
...
If you already logged in with the Qwen Code CLI, QingClaws will sync credentials
