---
summary: "Overview of QingClaws onboarding options and flows"
read_when:
...
QingClaws supports multiple onboarding paths depending on where the Gateway runs
...
- [`qingclaws onboard` command](/cli/onboard)

## macOS app onboarding

Use the QingClaws app when you want a fully guided setup on macOS. Docs:
