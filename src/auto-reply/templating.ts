...
export type MsgContext = {
  ...
  OutputDir?: string;
  OutputBase?: string;
  /** Remote host for SCP when media lives on a different machine (e.g., qingclaws@192.168.64.3). */
  ...
  SenderName?: string;
  SenderId?: string;
  /** Sender's union_id (cross-app stable identifier, e.g. Feishu union_id). */
