...
export const DEFAULT_SANDBOX_IMAGE = "qingclaws-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "qingclaws-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "qingclaws-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "qingclaws-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "qingclaws-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "qingclaws-sandbox-browser";
