...
const CLEANUP_STATE_KEY = Symbol.for("qingclaws.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("qingclaws.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("qingclaws.sessionWriteLockWatchdogState");
