...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @qingclaws/voice-call -> voice-call).
...
export function discoverQingClawsPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".qingclaws", "extensions")];
