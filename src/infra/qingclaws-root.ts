...
const CORE_PACKAGE_NAMES = new Set(["qingclaws", "qingclaws"]);
...
export async function resolveQingClawsPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveQingClawsPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
