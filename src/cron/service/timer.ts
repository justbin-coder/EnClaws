...
export async function onTimer(state: CronServiceState) {
  if (state.running) {
    ...
    // execution to finish.
    // See: https://github.com/qingclaws/qingclaws/issues/12025
...
> {
    ...
    if (job.wakeMode === "now" && state.deps.runHeartbeatOnce) {
      ...
      for (;;) {
        ...
        heartbeatResult = await state.deps.runHeartbeatOnce({
          ...
          // See: https://github.com/qingclaws/qingclaws/issues/28508
  ...
  // See: https://github.com/qingclaws/qingclaws/issues/15692
