...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "qingclaws", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for QingClaws. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("QingClaws Issue Label Audit");
