...
# Output:
# - dist/QingClaws.app
# - dist/QingClaws-<version>.zip
# - dist/QingClaws-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.qingclaws.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/QingClaws.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/QingClaws-$VERSION.zip"
DMG="$ROOT_DIR/dist/QingClaws-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/QingClaws-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/QingClaws-$VERSION.dSYM.zip"
