...
show_usage() {
    cat << EOF
clawlog - QingClaws Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View QingClaws logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    QingClaws logs flow through the macOS unified log (subsystem: ai.qingclaws).
